...
const ACTION_URL =
  "https://ref.supabase.co/auth/v1/verify?token=abc123&type=magiclink&redirect_to=https%3A%2F%2Fwinscore.app%2Fauth%2Fcallback";
...
describe("renderMagicLinkEmail", () => {
  ...
  it("includes a plain-text part mirroring the link and copy", () => {
    const { text } = renderMagicLinkEmail({
      actionUrl: ACTION_URL,
      strings: STRINGS,
    });
