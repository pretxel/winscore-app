...
**Winscore** is a predictions pool. The active competition is the FIFA World Cup 2026: every
signed-in user submits an exact-score prediction for each match, picks lock at kickoff, and a
daily / overall leaderboard ranks everyone in one global pool.
