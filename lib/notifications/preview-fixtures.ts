...
const COMIC_PLACEHOLDER =
  ...
  encodeURIComponent(
    `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400"><rect width="600" height="400" fill="#E7EFFC"/><text x="300" y="200" text-anchor="middle" font-family="sans-serif" font-size="24" fill="#135FD1">Recap comic</text></svg>`,
  );
