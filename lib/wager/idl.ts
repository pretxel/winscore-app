...
export type WinscoreWager = {
  ...
  instructions: [
    ...
    {
      name: "enter";
      discriminator: [139, 49, 209, 114, 88, 91, 77, 134];
      accounts: [
        {
          name: "entrant";
          writable: true;
    ...
    },
    {
      ...
      discriminator: [33, 19, 81, 247, 56, 249, 125, 217];
      accounts: [
        {
          name: "authority";
          writable: true;
        ...
        {
          name: "rentRecipientA";
          docs: ["First recipient for rent return on close"];
        },
        {
          name: "rentRecipientB";
          docs: ["Second recipient for rent return on close"];
        },
        {
          name: "systemProgram";
          address: "11111111111111111111111111111111";
    ...
    {
      name: "shortenClose";
      discriminator: [95, 140, 205, 21, 239, 165, 62, 89];
      accounts: [
        {
          name: "authority";
          signer: true;
  ...
  accounts: [
    ...
    {
      name: "wagerRound";
      discriminator: [135, 106, 114, 169, 253, 53, 43, 109];
    },
  ];
  errors: [
    {
