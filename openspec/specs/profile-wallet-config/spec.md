# profile-wallet-config

## Purpose

Rules governing the authenticated profile page and its Wallet section — the route, auth gating, how the active wallet link is resolved and displayed, and the link/unlink controls surfaced.
