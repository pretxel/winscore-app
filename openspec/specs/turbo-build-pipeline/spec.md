...
Rules governing the Turborepo build pipeline configuration — task caching, dependency ordering, package manager declaration, and local cache hygiene — enabling fast incremental runs locally and on Vercel deployments.
