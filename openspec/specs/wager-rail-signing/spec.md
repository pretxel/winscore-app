...
Rules governing the client-side wager rail — how wager intents are created server-side, how the connected Solana wallet is used to sign entry transactions, and how on-chain outcomes are surfaced.
